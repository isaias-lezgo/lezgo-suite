        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">¿Listo para Conectar Todo?</h2>
              <p className="text-xl mb-8 text-white/90">
                Comienza a integrar tus herramientas favoritas y experimenta la verdadera unificación digital.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button className="bg-white text-[#F59B1B] hover:bg-gray-100 px-8 py-3 text-lg font-semibold">
                  Comenzar Integraciones
                </Button>
                <Button
                  variant="outline"
