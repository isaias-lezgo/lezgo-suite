        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">¿Listo para Tomar Mejores Decisiones?</h2>
              <p className="text-xl mb-8 text-white/90">
                Descubre cómo nuestras herramientas de análisis pueden transformar tu estrategia empresarial.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
