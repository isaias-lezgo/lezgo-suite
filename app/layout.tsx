...
export default function RootLayout({
  ...
  return (
    <html lang="es" className={`${dmSans.variable} ${spaceGrotesk.variable}`}>
      <head>
        {/* Google Tag Manager — carga síncrona antes de cualquier otro script */}
        <script
...
})(window,document,'script','dataLayer','GTM-P8333HV6');`,
          }}
        />
      </head>
      <body>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-P8333HV6"
            height="0"
            width="0"
